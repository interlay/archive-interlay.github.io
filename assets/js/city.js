...
const City = {
  init: function (scene) {
    ...
    this.scene = scene
    this.wireframe = null
    this.uz = 0.5 // speed at which city is moving
  ...
  initMaterials: function () {
    this.cityMaterial = new THREE.MeshPhongMaterial({color: 0x250303})
  ...
  initLights: function () {
    this.light = new THREE.DirectionalLight(0x250303, City.lightIntensity)
